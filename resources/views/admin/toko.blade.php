    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
          <a href="{{url('toko')}}" class="nav-link active"><i class="nav-icon fa fa-home"></i> <p>Toko</p></a>
          </li>
          <li class="nav-item">
  ...
  <div class="content-wrapper">
    ...
    @if(Auth::user()->karyawan_level == 'ADMIN')
          ...
          <div class="modal-body">
              <form method="post" action="{{route('crudtoko.update', $t->toko_id)}}">
                @csrf
                @method('PUT')
                ...
                <input type="text" name="toko_nama" class="form-control" value="{{$t->toko_nama}}" id="nama" placeholder="Nama Toko..." readonly required>
                </label>
                </div>
                ...
                <textarea name="toko_alamat" class="form-control" id="alamat" placeholder="Alamat" readonly required>{{$t->toko_alamat}}</textarea>
                </label>
                </div>
                ...
                <input name="toko_hp" id="hp" type="number" class="form-control" placeholder="85348746" value="{{$t->toko_hp}}" readonly required>
                </label>
                </div>

                <button class="btn btn-success btn-md" type="submit" id="btnubah" style="display: none;">Ubah</button> 
                <button class="btn btn-secondary btn-md" type="button" id="btnaktif" data-dismiss="modal">Edit Toko</button>
              </form>
          </div>
          ...
          <script>
            document.querySelector("#btnaktif").addEventListener("click", function() {
              document.querySelector("#btnubah").style.display="block";
              document.querySelector("#btnaktif").style.display="none";
              document.querySelector("#nama").removeAttribute("readonly");
              document.querySelector("#alamat").removeAttribute("readonly");
              document.querySelector("#hp").removeAttribute("readonly");
            });
          </script>
          @endforeach
