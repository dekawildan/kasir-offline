  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-lg-12">
          <h3>Laporan Modal Belanja</h3>
            <hr>
          </div><!-- /.col -->
          <div class="col-md-12 bg-light px-5 py-5">
            
          <div class="table-responsive">
            <a href="{{url('cetakbeli')}}" target="_blank" class="btn btn-success btn-md"><i class="fa fa-print"></i> Cetak</a>
            ...
            <tbody>
                ...
                @foreach($laporan as $l)
                  <tr>
                    ...
                    <td>{{$l->satuan}}</td>
                    <td>{{number_format($l->harga_beli,0,",",".")}}</td>
                    <td>{{number_format($l->total_beli,0,",",".")}}</td>
                  </tr>
                @endforeach
            </tbody>  
            </table>
