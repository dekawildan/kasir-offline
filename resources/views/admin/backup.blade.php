    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('backupdatabase')}}" class="nav-link active">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          @if(Session::has('pesan'))
            ...
            <a href="db-backup/{{Session::get('dbfile')}}" class="btn btn-success"><i class="fas fa-download"></i> Download File Database</a>
          @endif
          <p>&nbsp;</p>
            <p>Silahkan klik tombol Backup Database untuk mencadangkan keseluruhan data pada aplikasi kasir</p>
            <a href="{{url('prosesbackup')}}" class="btn btn-success"><i class="fa fa-database fa-1x"></i> Backup Database</a>
